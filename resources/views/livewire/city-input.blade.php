    ...
    <form wire:submit.prevent="" action="#" method="get" class="w-full px-3">
        <div class="relative w-full mb-6 group">
            <input type="text" wire:model="" name="city" id="city"
                   class="block py-2.5 px-0 w-2/3 text-sm bg-transparent border-0 border-b-2 appearance-none border-gray-700 dark:border-gray-300 focus:border-blue-500 dark:focus:border-blue-200 focus:outline-none focus:ring-0 peer empty:text-inherit"
                   placeholder=" "/>
            <label for="city"
                   class="peer-focus:font-medium absolute text-sm duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-500 dark:peer-focus:text-blue-200 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Search for a city</label>
        </div>
    </form>
</div>
